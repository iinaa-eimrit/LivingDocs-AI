  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-black p-8">
      ...
      <nav className="flex flex-col gap-4">
        ...
        <Link href="/api-playground" className="rounded-lg bg-white dark:bg-zinc-900 p-4 shadow hover:bg-zinc-100 dark:hover:bg-zinc-800 text-lg font-medium">API Playground</Link>
      </nav>
    </div>
  );
}
